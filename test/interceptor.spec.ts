...
describe('interceptors', () => {
  ...
  test('should add a request interceptor that returns new config object', () => {
    const instance = axios.create()
  ...
  test('should add multiple request interceptors', () => {
    ...
    return getAjaxRequest().then(request => {
      ...
      expect(request.requestHeaders.test1).toBe('2')
      expect(request.requestHeaders.test1).toBe('3')
    })
  })
  ...
  test('should add a response interceptor than returns a new data object', done => {
    let response: AxiosResponse
    const instance = axios.create()
